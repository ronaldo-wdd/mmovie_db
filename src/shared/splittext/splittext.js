export function SplitText(identifier, vars){
	...
	for(var i = 0;i<identifier.length;i++){
		...
		if(typeof identifier[i] == "string"){
			var elements = document.querySelectorAll(identifier[i]);
	...
	for(var i = 0;i<this.HTMLobjects.length;i++){
		// console.log(this.HTMLobjects[i].innerHTML);
	...
	//add the revert function -- modified --
	this.revert = function(HTMLobjects, originalHTML){
		// for(var i = 0;i<HTMLobjects.length;i++){
		// 	HTMLobjects[i].innerHTML=originalHTML[i];
		// }
